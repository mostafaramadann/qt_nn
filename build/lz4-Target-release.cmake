...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET LZ4::lz4_static
                 ...
                 $<$<CONFIG:Release>:${lz4_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET LZ4::lz4_static
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${lz4_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET LZ4::lz4_static
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${lz4_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET LZ4::lz4_static
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${lz4_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET LZ4::lz4_static
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${lz4_COMPILE_OPTIONS_RELEASE}> APPEND)
