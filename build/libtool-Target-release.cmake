...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET libtool::libtool
                 ...
                 $<$<CONFIG:Release>:${libtool_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET libtool::libtool
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${libtool_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET libtool::libtool
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${libtool_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET libtool::libtool
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${libtool_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET libtool::libtool
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${libtool_COMPILE_OPTIONS_RELEASE}> APPEND)
