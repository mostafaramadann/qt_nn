...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT xorg::sm #############
        ...
        set_property(TARGET xorg::sm PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_sm_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::sm PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_sm_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::sm PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_sm_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::sm PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_sm_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::sm PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_sm_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::uuid #############
        ...
        set_property(TARGET xorg::uuid PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_uuid_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::uuid PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_uuid_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::uuid PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_uuid_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::uuid PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_uuid_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::uuid PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_uuid_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-dri3 #############
        ...
        set_property(TARGET xorg::xcb-dri3 PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-dri3_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-dri3 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-dri3_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-dri3 PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-dri3_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-dri3 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-dri3_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-dri3 PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-dri3_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-util #############
        ...
        set_property(TARGET xorg::xcb-util PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-util_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-util PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-util_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-util PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-util_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-util PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-util_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-util PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-util_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-event #############
        ...
        set_property(TARGET xorg::xcb-event PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-event_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-event PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-event_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-event PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-event_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-event PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-event_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-event PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-event_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-aux #############
        ...
        set_property(TARGET xorg::xcb-aux PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-aux_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-aux PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-aux_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-aux PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-aux_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-aux PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-aux_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-aux PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-aux_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-atom #############
        ...
        set_property(TARGET xorg::xcb-atom PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-atom_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-atom PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-atom_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-atom PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-atom_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-atom PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-atom_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-atom PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-atom_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb #############
        ...
        set_property(TARGET xorg::xcb PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-xinerama #############
        ...
        set_property(TARGET xorg::xcb-xinerama PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xinerama_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-xinerama PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xinerama_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-xinerama PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xinerama_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-xinerama PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xinerama_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-xinerama PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xinerama_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-xfixes #############
        ...
        set_property(TARGET xorg::xcb-xfixes PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xfixes_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-xfixes PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xfixes_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-xfixes PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xfixes_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-xfixes PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xfixes_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-xfixes PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xfixes_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-sync #############
        ...
        set_property(TARGET xorg::xcb-sync PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-sync_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-sync PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-sync_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-sync PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-sync_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-sync PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-sync_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-sync PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-sync_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-shm #############
        ...
        set_property(TARGET xorg::xcb-shm PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-shm_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-shm PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-shm_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-shm PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-shm_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-shm PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-shm_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-shm PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-shm_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-shape #############
        ...
        set_property(TARGET xorg::xcb-shape PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-shape_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-shape PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-shape_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-shape PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-shape_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-shape PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-shape_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-shape PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-shape_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-renderutil #############
        ...
        set_property(TARGET xorg::xcb-renderutil PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-renderutil_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-renderutil PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-renderutil_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-renderutil PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-renderutil_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-renderutil PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-renderutil_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-renderutil PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-renderutil_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-render #############
        ...
        set_property(TARGET xorg::xcb-render PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-render_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-render PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-render_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-render PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-render_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-render PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-render_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-render PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-render_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-randr #############
        ...
        set_property(TARGET xorg::xcb-randr PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-randr_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-randr PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-randr_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-randr PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-randr_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-randr PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-randr_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-randr PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-randr_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-keysyms #############
        ...
        set_property(TARGET xorg::xcb-keysyms PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-keysyms_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-keysyms PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-keysyms_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-keysyms PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-keysyms_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-keysyms PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-keysyms_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-keysyms PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-keysyms_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-image #############
        ...
        set_property(TARGET xorg::xcb-image PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-image_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-image PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-image_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-image PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-image_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-image PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-image_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-image PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-image_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-icccm #############
        ...
        set_property(TARGET xorg::xcb-icccm PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-icccm_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-icccm PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-icccm_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-icccm PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-icccm_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-icccm PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-icccm_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-icccm PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-icccm_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcb-xkb #############
        ...
        set_property(TARGET xorg::xcb-xkb PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xkb_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-xkb PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xkb_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-xkb PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xkb_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-xkb PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xkb_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcb-xkb PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcb-xkb_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xxf86vm #############
        ...
        set_property(TARGET xorg::xxf86vm PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xxf86vm_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xxf86vm PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xxf86vm_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xxf86vm PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xxf86vm_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xxf86vm PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xxf86vm_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xxf86vm PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xxf86vm_COMPILE_OPTIONS_RELEASE}> APPEND)

    ########## COMPONENT xorg::xvmc #############

        set(xorg_xorg_xvmc_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(xorg_xorg_xvmc_FRAMEWORKS_FOUND_RELEASE "${xorg_xorg_xvmc_FRAMEWORKS_RELEASE}" "${xorg_xorg_xvmc_FRAMEWORK_DIRS_RELEASE}")
        ...
        set_property(TARGET xorg_xorg_xvmc_DEPS_TARGET
                     PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${xorg_xorg_xvmc_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${xorg_xorg_xvmc_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${xorg_xorg_xvmc_DEPENDENCIES_RELEASE}>
                     APPEND)

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'xorg_xorg_xvmc_DEPS_TARGET' to all of them
        conan_package_library_targets("${xorg_xorg_xvmc_LIBS_RELEASE}"
                              "${xorg_xorg_xvmc_LIB_DIRS_RELEASE}"
                              "${xorg_xorg_xvmc_BIN_DIRS_RELEASE}" # package_bindir
                              "${xorg_xorg_xvmc_LIBRARY_TYPE_RELEASE}"
                              "${xorg_xorg_xvmc_IS_HOST_WINDOWS_RELEASE}"
        ...
        set_property(TARGET xorg::xvmc
                     PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${xorg_xorg_xvmc_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${xorg_xorg_xvmc_LIBRARIES_TARGETS}>
                     APPEND)

        if("${xorg_xorg_xvmc_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET xorg::xvmc
                         PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET xorg::xvmc PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xvmc_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xvmc PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xvmc_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xvmc PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xvmc_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xvmc PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xvmc_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xvmc PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xvmc_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xv #############
        ...
        set_property(TARGET xorg::xv PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xv_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xv PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xv_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xv PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xv_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xv PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xv_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xv PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xv_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xtst #############
        ...
        set_property(TARGET xorg::xtst PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xtst_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xtst PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xtst_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xtst PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xtst_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xtst PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xtst_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xtst PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xtst_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xt #############
        ...
        set_property(TARGET xorg::xt PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xt_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xt PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xt_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xt PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xt_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xt PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xt_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xt PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xt_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xscrnsaver #############
        ...
        set_property(TARGET xorg::xscrnsaver PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xscrnsaver_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xscrnsaver PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xscrnsaver_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xscrnsaver PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xscrnsaver_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xscrnsaver PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xscrnsaver_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xscrnsaver PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xscrnsaver_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xres #############
        ...
        set_property(TARGET xorg::xres PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xres_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xres PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xres_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xres PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xres_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xres PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xres_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xres PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xres_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xrender #############
        ...
        set_property(TARGET xorg::xrender PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xrender_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xrender PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xrender_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xrender PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xrender_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xrender PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xrender_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xrender PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xrender_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xrandr #############
        ...
        set_property(TARGET xorg::xrandr PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xrandr_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xrandr PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xrandr_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xrandr PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xrandr_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xrandr PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xrandr_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xrandr PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xrandr_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xpm #############
        ...
        set_property(TARGET xorg::xpm PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xpm_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xpm PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xpm_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xpm PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xpm_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xpm PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xpm_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xpm PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xpm_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xmuu #############
        ...
        set_property(TARGET xorg::xmuu PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xmuu_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xmuu PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xmuu_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xmuu PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xmuu_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xmuu PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xmuu_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xmuu PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xmuu_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xmu #############
        ...
        set_property(TARGET xorg::xmu PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xmu_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xmu PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xmu_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xmu PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xmu_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xmu PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xmu_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xmu PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xmu_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xkbfile #############
        ...
        set_property(TARGET xorg::xkbfile PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xkbfile_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xkbfile PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xkbfile_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xkbfile PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xkbfile_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xkbfile PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xkbfile_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xkbfile PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xkbfile_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xinerama #############
        ...
        set_property(TARGET xorg::xinerama PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xinerama_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xinerama PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xinerama_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xinerama PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xinerama_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xinerama PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xinerama_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xinerama PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xinerama_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xi #############
        ...
        set_property(TARGET xorg::xi PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xi_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xi PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xi_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xi PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xi_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xi PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xi_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xi PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xi_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xfixes #############
        ...
        set_property(TARGET xorg::xfixes PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xfixes_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xfixes PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xfixes_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xfixes PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xfixes_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xfixes PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xfixes_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xfixes PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xfixes_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xext #############
        ...
        set_property(TARGET xorg::xext PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xext_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xext PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xext_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xext PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xext_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xext PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xext_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xext PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xext_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xdmcp #############
        ...
        set_property(TARGET xorg::xdmcp PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xdmcp_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xdmcp PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xdmcp_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xdmcp PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xdmcp_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xdmcp PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xdmcp_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xdmcp PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xdmcp_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xdamage #############
        ...
        set_property(TARGET xorg::xdamage PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xdamage_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xdamage PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xdamage_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xdamage PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xdamage_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xdamage PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xdamage_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xdamage PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xdamage_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcursor #############
        ...
        set_property(TARGET xorg::xcursor PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcursor_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcursor PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcursor_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcursor PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcursor_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcursor PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcursor_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcursor PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcursor_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xcomposite #############
        ...
        set_property(TARGET xorg::xcomposite PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcomposite_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcomposite PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcomposite_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcomposite PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xcomposite_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcomposite PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcomposite_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xcomposite PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xcomposite_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xaw7 #############
        ...
        set_property(TARGET xorg::xaw7 PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xaw7_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xaw7 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xaw7_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xaw7 PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xaw7_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xaw7 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xaw7_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xaw7 PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xaw7_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::xau #############
        ...
        set_property(TARGET xorg::xau PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xau_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::xau PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xau_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xau PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_xau_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::xau PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xau_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::xau PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_xau_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::ice #############
        ...
        set_property(TARGET xorg::ice PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_ice_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::ice PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_ice_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::ice PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_ice_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::ice PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_ice_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::ice PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_ice_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::fontenc #############
        ...
        set_property(TARGET xorg::fontenc PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_fontenc_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::fontenc PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_fontenc_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::fontenc PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_fontenc_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::fontenc PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_fontenc_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::fontenc PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_fontenc_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::x11-xcb #############
        ...
        set_property(TARGET xorg::x11-xcb PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_x11-xcb_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::x11-xcb PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_x11-xcb_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::x11-xcb PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_x11-xcb_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::x11-xcb PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_x11-xcb_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::x11-xcb PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_x11-xcb_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xorg::x11 #############
        ...
        set_property(TARGET xorg::x11 PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_x11_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xorg::x11 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_x11_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::x11 PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xorg_xorg_x11_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xorg::x11 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xorg_xorg_x11_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xorg::x11 PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xorg_xorg_x11_COMPILE_OPTIONS_RELEASE}> APPEND)
