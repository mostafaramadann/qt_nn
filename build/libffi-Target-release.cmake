...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET libffi::libffi
                 ...
                 $<$<CONFIG:Release>:${libffi_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET libffi::libffi
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${libffi_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET libffi::libffi
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${libffi_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET libffi::libffi
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${libffi_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET libffi::libffi
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${libffi_COMPILE_OPTIONS_RELEASE}> APPEND)
