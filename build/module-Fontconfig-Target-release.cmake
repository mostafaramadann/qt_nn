...
set_property(TARGET fontconfig_DEPS_TARGET
             ...
             $<$<CONFIG:Release>:Freetype::Freetype;libuuid::libuuid;EXPAT::EXPAT>
             APPEND)
...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET Fontconfig::Fontconfig
                 ...
                 $<$<CONFIG:Release>:${fontconfig_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET Fontconfig::Fontconfig
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${fontconfig_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET Fontconfig::Fontconfig
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${fontconfig_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET Fontconfig::Fontconfig
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${fontconfig_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET Fontconfig::Fontconfig
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${fontconfig_COMPILE_OPTIONS_RELEASE}> APPEND)
