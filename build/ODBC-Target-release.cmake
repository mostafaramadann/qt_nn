...
set_property(TARGET odbc_DEPS_TARGET
             ...
             $<$<CONFIG:Release>:libtool::libtool;Iconv::Iconv>
             APPEND)
...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT odbc::odbccr #############
        ...
        set_property(TARGET odbc::odbccr PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${odbc_odbc_odbccr_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET odbc::odbccr PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${odbc_odbc_odbccr_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET odbc::odbccr PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${odbc_odbc_odbccr_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET odbc::odbccr PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${odbc_odbc_odbccr_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET odbc::odbccr PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${odbc_odbc_odbccr_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT odbc::odbcinst #############
        ...
        set_property(TARGET odbc::odbcinst PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${odbc_odbc_odbcinst_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET odbc::odbcinst PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${odbc_odbc_odbcinst_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET odbc::odbcinst PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${odbc_odbc_odbcinst_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET odbc::odbcinst PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${odbc_odbc_odbcinst_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET odbc::odbcinst PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${odbc_odbc_odbcinst_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT odbc::_odbc #############
        ...
        set_property(TARGET odbc::_odbc PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${odbc_odbc__odbc_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET odbc::_odbc PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${odbc_odbc__odbc_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET odbc::_odbc PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${odbc_odbc__odbc_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET odbc::_odbc PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${odbc_odbc__odbc_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET odbc::_odbc PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${odbc_odbc__odbc_COMPILE_OPTIONS_RELEASE}> APPEND)

    ########## AGGREGATED GLOBAL TARGET WITH THE COMPONENTS #####################
    set_property(TARGET ODBC::ODBC PROPERTY INTERFACE_LINK_LIBRARIES odbc::odbccr APPEND)
    set_property(TARGET ODBC::ODBC PROPERTY INTERFACE_LINK_LIBRARIES odbc::odbcinst APPEND)
    set_property(TARGET ODBC::ODBC PROPERTY INTERFACE_LINK_LIBRARIES odbc::_odbc APPEND)
