...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET autoconf::autoconf
                 ...
                 $<$<CONFIG:Release>:${autoconf_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET autoconf::autoconf
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${autoconf_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET autoconf::autoconf
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${autoconf_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET autoconf::autoconf
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${autoconf_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET autoconf::autoconf
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${autoconf_COMPILE_OPTIONS_RELEASE}> APPEND)
