...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET xkeyboard-config::xkeyboard-config
                 ...
                 $<$<CONFIG:Release>:${xkeyboard-config_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET xkeyboard-config::xkeyboard-config
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${xkeyboard-config_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET xkeyboard-config::xkeyboard-config
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${xkeyboard-config_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET xkeyboard-config::xkeyboard-config
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${xkeyboard-config_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET xkeyboard-config::xkeyboard-config
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${xkeyboard-config_COMPILE_OPTIONS_RELEASE}> APPEND)
