...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET m4::m4
                 ...
                 $<$<CONFIG:Release>:${m4_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET m4::m4
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${m4_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET m4::m4
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${m4_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET m4::m4
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${m4_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET m4::m4
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${m4_COMPILE_OPTIONS_RELEASE}> APPEND)
