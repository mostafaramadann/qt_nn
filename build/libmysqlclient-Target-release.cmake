...
set_property(TARGET libmysqlclient_DEPS_TARGET
             ...
             $<$<CONFIG:Release>:openssl::openssl;LZ4::lz4_static;ZLIB::ZLIB;zstd::libzstd_static>
             APPEND)
...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET libmysqlclient::libmysqlclient
                 ...
                 $<$<CONFIG:Release>:${libmysqlclient_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET libmysqlclient::libmysqlclient
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${libmysqlclient_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET libmysqlclient::libmysqlclient
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${libmysqlclient_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET libmysqlclient::libmysqlclient
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${libmysqlclient_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET libmysqlclient::libmysqlclient
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${libmysqlclient_COMPILE_OPTIONS_RELEASE}> APPEND)
