...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET automake::automake
                 ...
                 $<$<CONFIG:Release>:${automake_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET automake::automake
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${automake_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET automake::automake
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${automake_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET automake::automake
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${automake_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET automake::automake
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${automake_COMPILE_OPTIONS_RELEASE}> APPEND)
