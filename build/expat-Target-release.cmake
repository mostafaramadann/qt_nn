...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET expat::expat
                 ...
                 $<$<CONFIG:Release>:${expat_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET expat::expat
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${expat_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET expat::expat
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${expat_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET expat::expat
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${expat_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET expat::expat
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${expat_COMPILE_OPTIONS_RELEASE}> APPEND)
