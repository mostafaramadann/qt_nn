...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT xkbcommon::xkbcli-interactive-wayland #############
        ...
        set_property(TARGET xkbcommon::xkbcli-interactive-wayland PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_xkbcli-interactive-wayland_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::xkbcli-interactive-wayland PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_xkbcli-interactive-wayland_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::xkbcli-interactive-wayland PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_xkbcli-interactive-wayland_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::xkbcli-interactive-wayland PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_xkbcli-interactive-wayland_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::xkbcli-interactive-wayland PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_xkbcli-interactive-wayland_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xkbcommon::libxkbregistry #############
        ...
        set_property(TARGET xkbcommon::libxkbregistry PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbregistry_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::libxkbregistry PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbregistry_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::libxkbregistry PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbregistry_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::libxkbregistry PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbregistry_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::libxkbregistry PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbregistry_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xkbcommon::libxkbcommon-x11 #############
        ...
        set_property(TARGET xkbcommon::libxkbcommon-x11 PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbcommon-x11_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::libxkbcommon-x11 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbcommon-x11_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::libxkbcommon-x11 PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbcommon-x11_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::libxkbcommon-x11 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbcommon-x11_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::libxkbcommon-x11 PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbcommon-x11_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT xkbcommon::libxkbcommon #############
        ...
        set_property(TARGET xkbcommon::libxkbcommon PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbcommon_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::libxkbcommon PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbcommon_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::libxkbcommon PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbcommon_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::libxkbcommon PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbcommon_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET xkbcommon::libxkbcommon PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${xkbcommon_xkbcommon_libxkbcommon_COMPILE_OPTIONS_RELEASE}> APPEND)

    ########## AGGREGATED GLOBAL TARGET WITH THE COMPONENTS #####################
    set_property(TARGET xkbcommon::xkbcommon PROPERTY INTERFACE_LINK_LIBRARIES xkbcommon::xkbcli-interactive-wayland APPEND)
    set_property(TARGET xkbcommon::xkbcommon PROPERTY INTERFACE_LINK_LIBRARIES xkbcommon::libxkbregistry APPEND)
    set_property(TARGET xkbcommon::xkbcommon PROPERTY INTERFACE_LINK_LIBRARIES xkbcommon::libxkbcommon-x11 APPEND)
    set_property(TARGET xkbcommon::xkbcommon PROPERTY INTERFACE_LINK_LIBRARIES xkbcommon::libxkbcommon APPEND)
